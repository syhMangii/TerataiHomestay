...
<head>
    ...
    <title>KKM Daily Wellness Tracker - Patient Register</title>
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
        ...
        <nav id="navmenu" class="navmenu">
            <ul class="nav">
                ...
                <li class="nav-item"><a href="/loginadmin" class="nav-link text-white">Login As Admin</a></li>
            </ul>
                ...
                <div class="container p-2 p-sm-4">
                    ...
                    <div class="wide-xs mx-auto">
                        <div class="text-center mb-5">
                            ...
                            <div class="logo-wrap">
                                    <img style="width:250px; height:250px;" class="logo-img logo-light" src="logokkm.jpeg" srcset="logokkm.jpeg 2x"  alt="">
                                        <img style="width:250px; height:250px;" class="logo-img logo-dark" src="logokkm.jpeg" srcset="logokkm.jpeg 2x" alt="">
                                        <img style="width:250px; height:250px;" class="logo-img logo-icon" src="logokkm.jpeg" srcset="logokkm.jpeg 2x" alt="">
                                    </div>
                                </a>
                            </div>
