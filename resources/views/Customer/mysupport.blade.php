...
@media (max-width: 767px) {
    ...
    <section class="message-area">
        <div class="container">
            ...
            <h3 style="text-align: left;">Live Chat</h3>
            </div>
            <div class="col-6" style="margin-bottom:10px;">
            <a href="/homeusr" class="btn btn-md btn-danger" style="float: right;" onclick="confirmExit()">Exit Chat</a>
            </div>
                <div class="col-12">
                    <div class="chat-area">
                        <!-- chatlist -->
    ...
    <img src="{{ asset('logo.png') }}" style="width: 40px; height: 40px;" alt="">
    <span style="color: black; font-size: 12px; font-weight:bolder;">&nbsp;&nbsp;Teratai Anggun Sepintas</span>
</div>
                                        </div>
                                            ...
                                            <div class="tab-content" id="myTabContent">
                                                <div class="tab-pane fade show active" id="Open" role="tabpanel" aria-labelledby="Open-tab">
                                                    ...
                                                    <div class="chat-list">
                                                        ...
                                                        <a href="javascript()" onclick="window.location.href='custsupport?id={{ $contact->id }}'" class="d-flex align-items-center">
                        ...
                        <div class="chatbox">
                            <div class="modal-dialog-scrollable">
                                <div class="modal-content">
                                    ...
                                    <div class="send-box">
                                        <form action="sendReplyCustomer/{{$id}}" method="POST">
                                            @csrf
