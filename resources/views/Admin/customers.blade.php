            ...
            <div class="nk-content-body">
                ...
                <div class="nk-block-head">
                    ...
                    <ul class="d-flex">
                        ...
                        <li>
                            <a href="/createCustomer" class="btn btn-md d-md-none btn-primary">
                ...
                <a class="btn btn-success" href="{{ url('editCustomer', $cust->id) }}">Edit</a>
                <a class="btn btn-info" href="{{ url('viewCustomer', $cust->id) }}">View</a>
                {!! Form::open(['url' => ['deletecustomer', $cust->id], 'method' => 'DELETE', 'class' => 'delete-form', 'style' => 'display:inline;']) !!}
                    {!! Form::submit('Delete', ['class' => 'btn btn-danger', 'onclick' => 'return confirm("Are you sure you want to Delete this Customer?")']) !!}
                {!! Form::close() !!}
        </td>
