                        ...
                        <div class="container">
                            <div class="nk-content-inner">
                                <div class="nk-content-body">
                                                ...
                                                <div class="nk-block-head-content">
                                                    <div class="d-flex flex-column flex-md-row align-items-md-center">
                                                        ...
                                                        <div class="mt-3 mt-md-0 ms-md-3">
                                                            <h3 class="title mb-1" style="color:blue;"><u>VIEW CUSTOMER</u></h3>
                                    ...
                                    {!! Form::model($customer, ['url' => ['updateCustomer', $customer->id], 'method' => 'POST']) !!}
                                                    @csrf
                                    <div class="nk-block">
                                                    ...
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                <input type="number" class="form-control" id="phone" name="phone" value="{{ $customer->phone }}" disabled>
                                                                </div>
                                                            </div>
                                                        </div>
