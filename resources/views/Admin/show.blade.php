                                                ...
                                                <div class="nk-block-head-content">
                                                    <div class="d-flex flex-column flex-md-row align-items-md-center">
                                                        ...
                                                        <div class="mt-3 mt-md-0 ms-md-3">
                                                            <h3 class="title mb-1" style="color:blue;"><u>VIEW HOMESTAY</u></h3>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="homestay_name" name="homestay_name" value="{{ $homestays->homestay_name }}" disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                <input type="number" step="0.01" class="form-control" id="homestay_price" name="homestay_price" value="{{ $homestays->homestay_price }}"  disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <textarea class="form-control" maxlength="1000" rows="10" name="homestay_details" id="homestay_details" disabled>{{ $homestays->homestay_details }}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
